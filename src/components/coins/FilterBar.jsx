...
const dexesByChain = {
  ...
  base: ['aerodrome', 'baseswap', 'pancake-swap'],
  ...
  return (
    <div className="flex flex-wrap items-center gap-4 p-4 bg-card border-b border-border sticky top-0 z-10">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="flex flex-col">
          <span className="text-[10px] font-bold text-muted-foreground uppercase mb-1">Volume</span>
          <select
            className="bg-secondary text-xs rounded px-2 py-1 border-none focus:ring-1 focus:ring-ring outline-none"
        ...
        <div className="flex flex-col">
          <span className="text-[10px] font-bold text-muted-foreground uppercase mb-1">DEX</span>
          <select
            className="bg-secondary text-xs rounded px-2 py-1 border-none focus:ring-1 focus:ring-ring outline-none"
            value={filters.dex}
          ...
          >
            ...
            {dexesByChain[filters.chain]?.map(dex => (
              <option key={dex} value={dex}>{dex.charAt(0).toUpperCase() + dex.slice(1)}</option>
            ))}
          </select>
        </div>
      </div>
