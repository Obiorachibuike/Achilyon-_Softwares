...
const columns = [
  ...
  columnHelper.display({
    ...
    cell: info => {
      ...
      if (score > 100) color = 'text-yellow-400'
      if (score > 200) color = 'text-orange-400'
      if (score > 500) color = 'text-red-500 font-bold animate-pulse'
    ...
    <div className="overflow-x-auto min-h-[400px]">
      ...
      {data.length === 0 && (
        <div className="flex flex-col items-center justify-center py-20 text-muted-foreground">
          <p className="text-lg italic">No pairs found matching your criteria</p>
